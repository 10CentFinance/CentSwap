...
import { Text, Flex, Box, ErrorIcon, Button } from '@kongswap/uikit'
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any CentSwap LP tokens and CentSwap farms.
        </Text>
