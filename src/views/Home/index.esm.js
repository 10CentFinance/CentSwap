...
var Icon$1o = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("g", { clipPath: "url(#" + id + ")" },
            React.createElement("rect", { width: "32", height: "40", rx: "5.33333", transform: "matrix(-0.866025 -0.5 -0.5 0.866025 65.6667 24.29)", fill: "#004e80" }),
...
var Icon$_ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 25" }, props),
        ...
        React.createElement("ellipse", { cx: "12.5259", cy: "14.0971", rx: "8.89606", ry: "8.22211", fill: "#004e80" }),
        ...
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M18.6821 10.1773C18.5825 9.96784 18.4695 9.7613 18.3429 9.55858C16.4727 6.56549 12.3308 5.53998 9.09162 7.26804C5.85244 8.9961 4.74261 12.8234 6.61276 15.8164C6.73956 16.0194 6.87681 16.2133 7.02351 16.3979C5.65271 13.5147 6.82182 10.0792 9.84162 8.46822C12.8612 6.85733 16.6652 7.63925 18.6821 10.1773Z", fill: "#004e80" }),
...
var Icon$Y = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 25" }, props),
        ...
        React.createElement("path", { d: "M19.8989 24.1416L11.8536 16.0962C11.6583 15.901 11.6583 15.5844 11.8536 15.3891L15.3891 11.8536C15.5843 11.6583 15.9009 11.6583 16.0962 11.8536L24.1416 19.899C24.4325 20.1899 24.2671 20.6882 23.8599 20.7473L21.5113 21.0884C21.2923 21.1202 21.1202 21.2923 21.0884 21.5114L20.7473 23.8599C20.6882 24.2671 20.1899 24.4326 19.8989 24.1416Z", fill: "#004e80" }),
        React.createElement("path", { d: "M5.19774 24.1416L13.2431 16.0962C13.4384 15.901 13.4384 15.5844 13.2431 15.3891L9.70759 11.8536C9.51233 11.6583 9.19575 11.6583 9.00049 11.8536L0.955098 19.899C0.664132 20.1899 0.829575 20.6882 1.23679 20.7473L3.58535 21.0884C3.80441 21.1202 3.97648 21.2923 4.0083 21.5114L4.34938 23.8599C4.40852 24.2671 4.90677 24.4326 5.19774 24.1416Z", fill: "#004e80" }),
        ...
        React.createElement("ellipse", { rx: "6.64749", ry: "6.39038", transform: "matrix(0.882297 -0.470693 0.52989 0.848067 12.4778 12.6875)", fill: "#004e80" }),
...
var Icon$K = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("g", { clipPath: "url(#" + id + ")" },
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M43.1934 10.6907C44.0412 9.92381 45.4 10.3246 45.6959 11.4288C45.9144 12.2444 45.4304 13.0827 44.6148 13.3012L38.4955 14.9409L43.1934 10.6907ZM49.112 10.5134C48.1317 6.85481 43.6295 5.52698 40.8207 8.06806L31.0187 16.9358C29.5584 18.2569 30.8604 20.6481 32.7625 20.1385L45.5302 16.7174C48.2324 15.9933 49.8361 13.2157 49.112 10.5134Z", fill: "#004e80" }),
            ...
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M18.2737 36.0462L45.4742 28.7579C46.8399 28.392 48.2436 29.2024 48.6095 30.5681L53.1648 47.5684C53.5307 48.934 52.7202 50.3378 51.3546 50.7037L24.1541 57.9921C22.7884 58.358 21.3847 57.5475 21.0187 56.1819L16.4635 39.1816C16.0976 37.8159 16.9081 36.4122 18.2737 36.0462ZM44.8116 26.2851C47.543 25.5533 50.3505 27.1742 51.0823 29.9055L55.6375 46.9058C56.3694 49.6371 54.7485 52.4446 52.0171 53.1765L24.8167 60.4648C22.0853 61.1967 19.2778 59.5758 18.546 56.8444L13.9908 39.8441C13.2589 37.1128 14.8798 34.3053 17.6112 33.5735L44.8116 26.2851Z", fill: "#004e80" }),
            React.createElement("path", { d: "M35.2297 28.8525L27.1932 31.0059L34.3987 57.8973L42.4352 55.7439L35.2297 28.8525Z", fill: "#004e80" }),
            React.createElement("path", { d: "M54.5173 42.4023L52.3639 34.3658L15.1113 44.3476L17.2647 52.3841L54.5173 42.4023Z", fill: "#004e80" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M39.9264 46.3239L31.8613 48.485L32.1926 49.7213L40.2577 47.5603L39.9264 46.3239ZM29.7019 40.4262L37.767 38.2651L37.4358 37.0287L29.3707 39.1898L29.7019 40.4262Z", fill: "#004e80" })),
            ...
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M16.8339 13.4384L51.4527 22.7145C52.1355 22.8975 52.5408 23.5993 52.3578 24.2822L51.4468 27.6822C51.2638 28.3651 50.5619 28.7703 49.8791 28.5873L15.2603 19.3113C14.5775 19.1283 14.1722 18.4264 14.3552 17.7436L15.2662 14.3435C15.4492 13.6607 16.1511 13.2555 16.8339 13.4384ZM52.1153 20.2417C54.1638 20.7906 55.3795 22.8962 54.8306 24.9448L53.9195 28.3448C53.3706 30.3933 51.265 31.609 49.2165 31.0601L14.5977 21.784C12.5492 21.2351 11.3335 19.1295 11.8824 17.081L12.7935 13.681C13.3424 11.6324 15.448 10.4168 17.4965 10.9657L52.1153 20.2417Z", fill: "#004e80" }),
            React.createElement("path", { d: "M38.8242 16.6804L30.7877 14.527L27.8889 25.3454L35.9254 27.4988L38.8242 16.6804Z", fill: "#004e80" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M38.4257 18.0799L30.4256 15.8399L30.7455 14.3999L38.8813 16.6573L38.4257 18.0799Z", fill: "#004e80" }))),
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear_won", x1: "31.2114", y1: "29.9293", x2: "38.4169", y2: "56.8207", gradientUnits: "userSpaceOnUse" },
                ...
                React.createElement("stop", { offset: "1", stopColor: "#004e80" })),
...
var Icon$J = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 25" }, props),
        React.createElement("g", { clipPath: "url(#" + id + ")" },
            React.createElement("path", { d: "M15.9617 4.03476C16.5597 2.82143 15.6818 1.40061 14.2254 1.22477C13.0389 1.08149 11.9708 1.84428 11.8399 2.9285L11.3896 6.65764C11.2976 7.41951 11.899 8.11875 12.7328 8.21943C13.3889 8.29864 14.0166 7.98162 14.286 7.435L15.9617 4.03476Z", fill: "#004e80" }),
            React.createElement("path", { d: "M6.27612 5.16903C5.36287 4.17118 5.80868 2.56162 7.15782 1.98574C8.25706 1.51653 9.49573 1.95041 9.92446 2.95482L11.3991 6.40949C11.7004 7.11529 11.3184 7.95473 10.546 8.28444C9.93817 8.54388 9.24684 8.41494 8.83541 7.9654L6.27612 5.16903Z", fill: "#004e80" }),
            React.createElement("path", { d: "M17.0349 9.11691C17.3916 11.6186 15.2219 13.6784 12.2437 14.1031C9.26546 14.5278 6.60649 13.1564 6.24978 10.6548C5.89307 8.15311 8.06278 6.09324 11.041 5.66857C14.0192 5.24391 16.6782 6.61525 17.0349 9.11691Z", fill: "#004e80" }),
...
var PancakeToggle = function (_a) {
    ...
    return (React.createElement(PancakeStack, { scale: scale },
        ...
        React.createElement(PancakeLabel, { scale: scale, checked: checked, htmlFor: props.id || "pancake-toggle" },
            React.createElement("div", { className: "10Cent" },
                React.createElement("div", { className: "10Cent" }),
                React.createElement("div", { className: "10Cent" }),
                React.createElement("div", { className: "10Cent" }),
                React.createElement("div", { className: "10Cent" })))));
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #004e80, 0px 0px 0px 4px rgba(118, 69, 217, 0.6)",
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#280D5F", textDisabled: "#BDC2C4", textSubtle: "#004e80", borderColor: "#E9EAEB", gradients: {
...
var Logo$2 = function (_a) {
    ...
    React.createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fillRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: "2", clipRule: "evenodd", viewBox: "0 0 470 90" }, props),
        React.createElement("g", { transform: "translate(-160 -20) scale(1 1.12909)" },
            React.createElement("g", { transform: "matrix(.7228 0 0 .66425 -276.718 -84.121)" },
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.323-.68c-.147 0-.302.073-.302.22 0 .233.333.165.333.336 0 .044-.026.068-.071.068-.065 0-.076-.056-.076-.122 0-.023.002-.034.005-.057A1.02 1.02 0 00.16-.237c-.079 0-.149.044-.149.13 0 .107.148.129.255.129.171 0 .317-.056.317-.227C.583-.438.25-.37.25-.541c0-.035.021-.061.056-.061.046 0 .061.035.061.079a.597.597 0 01-.005.073l.052.002c.079 0 .149-.029.149-.115 0-.093-.147-.117-.24-.117z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(2782.07 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.366-.034c.026.032.069.049.14.049A.232.232 0 00.615-.01a.231.231 0 01-.031-.124V-.33c0-.155-.128-.2-.283-.2-.085 0-.26.025-.26.142 0 .059.058.087.122.087a.231.231 0 00.069-.011.939.939 0 01-.002-.053c0-.056.013-.106.061-.106.052 0 .053.055.053.1v.085c-.148 0-.339.014-.339.157 0 .108.096.151.203.151.05 0 .107-.005.158-.056zM.292-.051c-.041 0-.053-.041-.053-.082 0-.071.029-.103.105-.103v.088c0 .043-.009.097-.052.097z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(2819.39 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.064.017L.304 0v-.465h.078V-.51H.304v-.06c0-.043-.001-.101.042-.101.027 0 .034.03.034.058a.87.87 0 01-.002.052.174.174 0 00.06.008c.057 0 .131-.017.131-.073C.569-.709.437-.72.353-.72c-.137 0-.277.026-.286.164L.064-.51h-.065v.045h.065v.482z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(2858.28 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.518-.186c-.027.047-.086.064-.139.064-.076 0-.103-.041-.109-.111a.285.285 0 00.049.004c.135 0 .254-.022.254-.157C.573-.496.45-.53.34-.53c-.19 0-.314.072-.314.262 0 .186.112.29.298.29.105 0 .225-.041.225-.146 0-.024-.009-.051-.031-.062zM.327-.468c.036 0 .043.043.043.079 0 .072-.03.111-.084.112L.269-.278c-.001-.061.002-.19.058-.19z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(2882.28 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.894 0v-.66h-.33l-.096.313L.372-.66H.045V0h.123v-.49L.331 0h.136L.63-.491V0h.264z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(2918.54 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.366-.034c.026.032.069.049.14.049A.232.232 0 00.615-.01a.231.231 0 01-.031-.124V-.33c0-.155-.128-.2-.283-.2-.085 0-.26.025-.26.142 0 .059.058.087.122.087a.231.231 0 00.069-.011.939.939 0 01-.002-.053c0-.056.013-.106.061-.106.052 0 .053.055.053.1v.085c-.148 0-.339.014-.339.157 0 .108.096.151.203.151.05 0 .107-.005.158-.056zM.292-.051c-.041 0-.053-.041-.053-.082 0-.071.029-.103.105-.103v.088c0 .043-.009.097-.052.097z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(2977.18 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.037-.51V0h.24v-.351c0-.042-.007-.104.035-.104.041 0 .037.068.037.109V0h.24v-.351c0-.038-.004-.104.033-.104.035 0 .031.068.031.109v.215c0 .102.063.146.164.146.03 0 .081-.007.107-.025a.231.231 0 01-.031-.124v-.208C.893-.463.84-.53.719-.53c-.062 0-.122.016-.154.071C.536-.505.483-.53.409-.53c-.081 0-.141.022-.17.098l-.01-.09-.192.012z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(3016.07 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.037-.51V0h.24v-.351c0-.042-.007-.104.035-.104.041 0 .037.068.037.109V0h.24v-.351c0-.038-.004-.104.033-.104.035 0 .031.068.031.109v.215c0 .102.063.146.164.146.03 0 .081-.007.107-.025a.231.231 0 01-.031-.124v-.208C.893-.463.84-.53.719-.53c-.062 0-.122.016-.154.071C.536-.505.483-.53.409-.53c-.081 0-.141.022-.17.098l-.01-.09-.192.012z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(3074.27 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.316-.53c-.182 0-.29.097-.29.278 0 .166.117.274.284.274.172 0 .289-.111.289-.284C.599-.443.497-.53.316-.53zm-.003.492c-.047 0-.046-.131-.046-.219 0-.091-.004-.213.046-.213.049 0 .046.122.046.213 0 .088 0 .219-.046.219z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(3132.47 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.005-.465h.059v.339c0 .093.058.141.152.141.074 0 .122-.017.152-.064-.051 0-.065-.035-.065-.075v-.341h.09V-.51H.302v-.114H.234a.79.79 0 01-.228.127l-.001.032z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(3171.54 250.528) scale(62.5156)" }),
                React.createElement("path", { fill: "#004E80", fillRule: "nonzero", d: "M.285-.601v-.123L.045-.7V0h.24v-.351c0-.042-.006-.104.036-.104.04 0 .037.068.037.109v.215c0 .102.063.146.164.146A.224.224 0 00.629-.01a.231.231 0 01-.031-.124v-.208C.598-.468.54-.53.414-.53c-.048 0-.101.008-.137.045.008-.032.008-.099.008-.116z", transform: "translate(-2469.88 -49.022) scale(1.15171) translate(3194.43 250.528) scale(62.5156)" }),
                React.createElement("g", { transform: "matrix(.1701 0 0 .1701 555.342 104.44)" },
                    React.createElement("path", { fill: "#004E80", d: "M640 287.278c-194.673 0-352.722 158.049-352.722 352.722 0 194.673 158.049 352.722 352.722 352.722 194.673 0 352.722-158.049 352.722-352.722 0-194.673-158.049-352.722-352.722-352.722zm-4.618 35.868c-177.426 0-321.472 144.047-321.472 321.472 0 177.426 144.046 321.472 321.472 321.472 177.425 0 321.472-144.046 321.472-321.472 0-177.425-144.047-321.472-321.472-321.472z" }),
                    React.createElement("circle", { cx: "490.667", cy: "695.111", r: "188.444", fill: "#004E80", transform: "translate(-120.291 -425.918) scale(1.54009)" }),
                    React.createElement("g", { transform: "translate(-4.618 4.005)" },
                        React.createElement("use", { width: "61.262", height: "54.052", x: "12.315", y: "21.405", transform: "matrix(8.13333 0 0 7.83827 291.896 283.273) scale(.9881 .98277)", xlinkHref: "#_Image1" }))))),
        React.createElement("defs", null,
            React.createElement("image", { id: "_Image1", width: "62", height: "55", xlinkHref: "data:image/png;base64," }))));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "10Cent home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "10Cent home page" }, innerLogo))));
};
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/+-CmErtYI9Tg4YzA5",
            },
            {
                label: "Español",
                href: "https://t.me/+bvG_i6Vbc21hY2Ux",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/10CentToken",
    },
];
var MENU_HEIGHT = 64;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/0xb1946985195718C3781fE341Db2C75A9986CB197", target: "_blank" },
