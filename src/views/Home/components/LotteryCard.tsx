...
import { Heading, Card, CardBody, Button, useModal } from '@kongswap/uikit'
...
const StyledLotteryCard = styled(Card)`
  background-image: url('/images/ticket-kong-bg.svg');
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <CardImage src="/images/ticket-kong.svg" alt="10cent logo" width={64} height={64} />
        <Block>
          <Label>{t('10CENT to Collect')}:</Label>
