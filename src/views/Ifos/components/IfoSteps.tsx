...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@kongswap/uikit'
    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active 10CentSwap Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get 10Cent-BNB LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake 10CENT and BNB in the liquidity pool to get LP tokens.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent 10CENT-BNB LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
