...
import { Modal, ModalBody, Text, Image, Button, Link, OpenNewIcon } from '@kongswap/uikit'
    ...
    <Modal title={t('LP Tokens required')} onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        <Image
          ...
          mb="24px"
        />
        <Text mb="16px">{t('You’ll need 10CENT-BNB LP tokens to participate in the IFO!')}</Text>
