...
import { Text, Flex, Box, Image, CheckmarkCircleIcon, FlexProps, HelpIcon, useTooltip } from '@kongswap/uikit'
...
const IfoCardTokens: React.FC<IfoCardTokensProps> = ({
  ...
  const renderTokenSection = () => {
    ...
    if (account && !hasProfile) {
      return <Text textAlign="center">{t('You need an active 10CentFinance Profile to take part in an IFO!')}</Text>
    }
