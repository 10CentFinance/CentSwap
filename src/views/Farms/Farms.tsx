...
import { Image, Heading, RowType, Toggle, Text } from '@kongswap/uikit'
...
const Farms: React.FC = () => {
  ...
  const [viewMode, setViewMode] = usePersistState(ViewMode.TABLE, '10cent_farm_view')
  ...
  const rowData = farmsStakedMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('10CENT', '')
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <StyledImage src="/images/token-kong.svg" alt="10Cent illustration" width={120} height={103} />
      </Page>
    </>
  )
}
